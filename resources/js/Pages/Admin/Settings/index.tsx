...
const Settings = ({ setting }: any) => {
  ...
  const {
    ...
    neighborhood: setting?.neighborhood ?setting?.neighborhood : '',
    ...
    opening: setting?.opening ? setting?.opening : '',
    metatitle: setting?.metatitle ? setting?.metatitle : '',
    metakeyword: setting?.metakeyword ? setting?.metakeyword : '',
